...
ICSMainWindow::_SaveSettings(void)
{
    ...
    settings
        ...
        << "Split11" << (float)fSplitView1->ItemWeight((int32)1)
        << "Split20" << (float)fSplitView2->ItemWeight((int32)0)
        << "Split21" << (float)fSplitView2->ItemWeight((int32)1)
        << "Split30" << (float)fSplitView3->ItemWeight((int32)0)
        << "Split31" << (float)fSplitView3->ItemWeight((int32)1)
        << "Split40" << (float)fSplitView4->ItemWeight((int32)0)
        << "Split41" << (float)fSplitView4->ItemWeight((int32)1)
        << std::endl;
}
